...
public abstract class BaseStudentPeer
{
    ...
    // ------------- Column: group_id --------------------
        ...
        GROUP_ID.setDescription("Foreign Key Author");
        GROUP_ID.setPosition(5);
    ...
    *
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Student> doSelectJoinUsergroup(Criteria criteria)
        throws TorqueException
    {
        return getStudentPeerImpl().doSelectJoinUsergroup(criteria);
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public static List<Student> doSelectJoinUsergroup(
            Criteria criteria, Connection conn)
        throws TorqueException
    {
        return getStudentPeerImpl().doSelectJoinUsergroup(criteria, conn);
    }
     ...
     */
    public static void setAndSaveUsers(
            Student toLinkTo,
            Collection<User> toSave) 
        throws TorqueException
    {
        getStudentPeerImpl().setAndSaveUsers(toLinkTo, toSave);
    }
    ...
    public static void setAndSaveNotes(
        ...
        throws TorqueException
    {
        getStudentPeerImpl().setAndSaveNotes(toLinkTo, toSave);
    }
     ...
     * @throws NullPointerException if toFill is null or contains null elements.
     */
    public static void setAndSaveAbscences(
            Student toLinkTo,
            Collection<Abscence> toSave) 
        throws TorqueException
    {
        getStudentPeerImpl().setAndSaveAbscences(toLinkTo, toSave);
    }
