 ...
 * extended; all references should be to Abscence
 */
public abstract class BaseAbscence 
    implements Persistent, Serializable, ColumnAccessByName
{
    /** Serial version */
    private static final long serialVersionUID = 1393184357728L;



    /** Abscence Id */
    private int abscenceId = 0;
    ...
    /**
     * Get the value of abscenceId.
     * The field is described as follows: 
     * Abscence Id
     *
     * @return int
     */
    public int getAbscenceId() 
    {
    ...
    /**
     * Set the value of abscenceId.
     * The field is described as follows: 
     * Abscence Id
     *
     * @param v new value
     */
    public void setAbscenceId(int v)
    {
        if (this.abscenceId != v)
        {
            setModified(true);
        }
    ...
    {
        if (name.equals("AbscenceId"))
        {
            return new Integer(getAbscenceId());
        }
        if (name.equals("Date"))
        {
            return getDate();
        ...
        throws TorqueException, IllegalArgumentException
    {
        if (name.equals("AbscenceId"))
        {
            ...
            setAbscenceId(((Integer) value).intValue());
            return true;
        }
        if (name.equals("Date"))
        {
    ...
    {
        if (name.equals(fr.iut2.sil4.data.AbscencePeer.ABSCENCE_ID))
        {
            return new Integer(getAbscenceId());
        }
        if (name.equals(fr.iut2.sil4.data.AbscencePeer.DATE))
        {
            return getDate();
        }
        if (name.equals(fr.iut2.sil4.data.AbscencePeer.MOTIF))
        {
            return getMotif();
        }
        if (name.equals(fr.iut2.sil4.data.AbscencePeer.STUDENT_ID))
        {
            return new Integer(getStudentId());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (fr.iut2.sil4.data.AbscencePeer.ABSCENCE_ID.getSqlExpression().equals(name))
        {
            return setByName("AbscenceId", value);
        }
        if (fr.iut2.sil4.data.AbscencePeer.DATE.getSqlExpression().equals(name))
        {
            return setByName("Date", value);
        }
        if (fr.iut2.sil4.data.AbscencePeer.MOTIF.getSqlExpression().equals(name))
        {
            return setByName("Motif", value);
        }
        if (fr.iut2.sil4.data.AbscencePeer.STUDENT_ID.getSqlExpression().equals(name))
        {
    ...
    {
        save(AbscencePeer.DATABASE_NAME);
    }
            ...
            throws TorqueException
    {
        ...
        try
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    AbscencePeer.doInsert((Abscence) this, con);
                    setNew(false);
                }
                else
                {
                    AbscencePeer.doUpdate((Abscence) this, con);
                }
            }
     ...
     *
     * @param key abscenceId ObjectKey
     */
    public void setPrimaryKey(ObjectKey key)
        
    {
        setAbscenceId(((NumberKey) key).intValue());
    }
    ...
    {
        setAbscenceId(Integer.parseInt(key));
    }
    ...
    {
        return SimpleKey.keyFor(getAbscenceId());
    }
     ...
     */
    public Abscence copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public Abscence copy(Connection con) throws TorqueException
    {
     ...
     */
    public Abscence copy(boolean deepcopy) throws TorqueException
    {
        Abscence abscence = new Abscence();

        return copyInto(abscence, deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public Abscence copy(boolean deepcopy, Connection con) throws TorqueException
    {
        Abscence abscence = new Abscence();

        return copyInto(abscence, deepcopy, con);
    }
     ...
     */
    public Abscence copyInto(Abscence copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    public Abscence copyInto(Abscence copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected Abscence copyInto(Abscence copyObj, boolean deepcopy) throws TorqueException
    {
        copyObj.setAbscenceId(0);
     ...
     * @param con the database connection to read associated objects.
     */
    public Abscence copyInto(Abscence copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setAbscenceId(0);
        copyObj.setDate(date);
        copyObj.setMotif(motif);
    ...
    /** The Peer class */
    private static final fr.iut2.sil4.data.AbscencePeer peer
            = new fr.iut2.sil4.data.AbscencePeer();
     ...
     */
    public fr.iut2.sil4.data.AbscencePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return fr.iut2.sil4.data.AbscencePeer.getTableMap();
    }
    ...
    public String toString()
    {
        ...
        str.append("Abscence:\n");
        str.append("abscenceId = ")
           .append(getAbscenceId())
           .append("\n");
        str.append("date = ")
           .append(getDate())
           .append("\n");
    ...
    public boolean equals(Object toCompare)
    {
        ...
        Abscence other = (Abscence) toCompare;
     ...
     */
    public boolean valueEquals(Abscence toCompare)
    {
        if (toCompare == null)
        {
            return false;
        ...
        if (this.abscenceId != toCompare.getAbscenceId())
        {
            return false;
        }
        ...
        if (!ObjectUtils.equals(this.motif, toCompare.getMotif()))
        {
            return false;
        }
