...
{
    /** Serial version */
    private static final long serialVersionUID = 1393184357652L;
    ...
    public Object getByPeerName(String name)
    {
        ...
        if (name.equals(fr.iut2.sil4.data.NotePeer.CONTROLE_ID))
        {
            return new Integer(getControleId());
        }
        if (name.equals(fr.iut2.sil4.data.NotePeer.POINTS))
        {
            return new Integer(getPoints());
        }
        if (name.equals(fr.iut2.sil4.data.NotePeer.STUDENT_ID))
        {
            return new Integer(getStudentId());
        }
        return null;
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (fr.iut2.sil4.data.NotePeer.CONTROLE_ID.getSqlExpression().equals(name))
        {
            return setByName("ControleId", value);
        }
        if (fr.iut2.sil4.data.NotePeer.POINTS.getSqlExpression().equals(name))
        {
            return setByName("Points", value);
        }
        if (fr.iut2.sil4.data.NotePeer.STUDENT_ID.getSqlExpression().equals(name))
        {
    ...
    public boolean valueEquals(Note toCompare)
    {
        ...
        if (this.controleId != toCompare.getControleId())
        {
            return false;
        }
        if (this.points != toCompare.getPoints())
        {
            return false;
        }
